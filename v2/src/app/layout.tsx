...
export const metadata: Metadata = {
  title: "OmniCRM - Başkent WP Entegre",
  description: "Advanced Agentic Omnichannel CRM System",
};
...
export default function RootLayout({
  ...
  return (
    ...
    >
      <body className="h-full flex flex-col md:flex-row bg-[#F2F2F7] text-[#1D1D1F] overflow-hidden">
