...
export async function handleWhatsAppMessage(body) {
  try {
    ...
    const channelBotEnabled = await getSetting('channel_whatsapp_enabled', 'true');
...
Eğer tıbbi değilse sadece "Teşekkürler, fotoğrafınız bize ulaştı." yaz.` }
    ...
    // 5. Maks bot mesaj kontrolü (Bot Yönetimi'nden ayarlanabilir)
